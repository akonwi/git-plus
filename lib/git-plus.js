...
import { addFromContext } from "./models/context/add";
    ...
    if (repos.length > 0) {
      ...
      this.subscriptions.add(
        atom.commands.add(".tree-view", {
          "git-plus-context:add": () => addFromContext(this.treeView),
          "git-plus-context:add-and-commit": () => GitAddAndCommitContext(this.treeView),
