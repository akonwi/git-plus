...
GitPushForce           = require './models/git-push-force'
...
module.exports =
  ...
  activate: (state) ->
    ...
    @subscriptions.add atom.commands.add 'atom-workspace', 'git-plus:push-force', -> git.getRepo().then((repo) -> GitPushForce(repo))
