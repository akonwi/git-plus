...
class StashListView {
  ...
  attach() {
    ...
    this.panel = atom.workspace.addModalPanel({ item: this.stashListView.element })
    this.stashListView.focus()
