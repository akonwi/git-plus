(function() {
  ...
  var textmateRegistry = registry.textmateRegistry || registry

  var baseWordGrammar = textmateRegistry.readGrammarSync(path.join(__dirname, 'word-diff.json'))
  baseWordGrammar.packageName = 'git-plus'
  var wordGrammar = Object.create(baseWordGrammar)
  wordGrammar.tokenizeLine = tokenizeLine

  var baseLineGrammar = textmateRegistry.readGrammarSync(path.join(__dirname, 'line-diff.json'))
